...
const translations = {
    ...
    'zh-TW': {
        ...
        'btn_view_example': '查看示例 & 指引',
        'dialog_title_guide': '匯入指引與範例',
        'guide_label': 'AI 轉換指引：',
        'guide_prompt': '可以告訴 AI：<br>「請把我下面的直播源改成和範例一樣的格式，logo 請在網上自己搜尋，favicon.ico 是最佳。」',
        'search_placeholder': '搜尋電台...',
        'search_result': '找到 {count} 個電台',
        'language_switch': '語言',
        'language_simplified': '简体中文',
        'language_traditional': '繁體中文',
        'language_english': 'English'
    ...
    'en': {
        ...
        'dialog_desc': 'Baipin Radio will try to connect directly first. If it fails, it will use server proxy to let you enjoy radio services anywhere in the world.',
        'field_name': 'Name',
        'field_url': 'URL',
        ...
        'btn_view_example': 'View Example & Guide',
        'dialog_title_guide': 'Import Guide & Example',
        'guide_label': 'AI Instructions:',
        'guide_prompt': 'You can tell the AI:<br>"Please convert my sources to the same format as the example. Search for logos online; favicon.ico is preferred."',
        'search_placeholder': 'Search stations...',
        'search_result': 'Found {count} stations',
